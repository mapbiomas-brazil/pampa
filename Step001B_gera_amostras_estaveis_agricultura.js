...
var collection = ee.ImageCollection('projects/mapbiomas-workspace/TRANSVERSAIS/AGRICULTURA4-FT')
...
Export.image.toAsset({
    ...
    "assetId": dirout + 'Pampa_amostras_estaveis85a18a_col41_somente_agricultura',
    "scale": 30,
    "pyramidingPolicy": {
        '.default': 'mode'
    },
