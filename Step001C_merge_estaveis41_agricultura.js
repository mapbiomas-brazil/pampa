...
var estaveis41 = ee.Image('projects/mapbiomas-workspace/AMOSTRAS/col5/PAMPA/Pampa_amostras_estaveis85a18a_col41')

var estaveisAgri = ee.Image('projects/mapbiomas-workspace/AMOSTRAS/col5/PAMPA/Pampa_amostras_estaveis85a18a_col41_somente_agricultura')
...
var temp = estaveisAgri.unmask(ee.Image(1))
Map.addLayer(temp)

var estaveis_com_agri = estaveis41.add(estaveisAgri.unmask(ee.Image(1)).remap([1, 19],[0, 100]))
estaveis_com_agri = estaveis_com_agri.remap([   0,   3,  11,  12,  21,  22,  29,  33,
...
Map.addLayer(estaveis_com_agri, visclass, 'estaveis_com_agri_preMask', true)

estaveis_com_agri = estaveis_com_agri.mask(estaveis_com_agri.neq(27)).rename("reference")


Map.addLayer(estaveis41, visclass, 'estaveis41', false)    
Map.addLayer(estaveisAgri, visclass, 'estaveisAgri', false)  
Map.addLayer(estaveis_com_agri, visclass, 'estaveis_com_agri', true)  
 

  Export.image.toAsset({
    "image": estaveis_com_agri.toByte(),
    "description": 'Pampa_amostras_estaveis85a18a_col41_com_agricultura',
    "assetId": 'projects/mapbiomas-workspace/AMOSTRAS/col5/PAMPA/Pampa_amostras_estaveis85a18a_col41_com_agricultura',
    "scale": 30,
    "pyramidingPolicy": {
        '.default': 'mode'
    },
